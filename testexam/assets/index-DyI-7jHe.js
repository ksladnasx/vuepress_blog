import{j as e,M as ls,r as ms,a as us}from"./vendor-markdown-DurMAUoW.js";import{a as ps,b as p,R as pe,u as Qe,N as ke,O as ys,c as oe,L as E,d as Ge,e as fs,f as G,H as hs}from"./vendor-react-BBDYwFnM.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const d of document.querySelectorAll('link[rel="modulepreload"]'))r(d);new MutationObserver(d=>{for(const o of d)if(o.type==="childList")for(const h of o.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&r(h)}).observe(document,{childList:!0,subtree:!0});function n(d){const o={};return d.integrity&&(o.integrity=d.integrity),d.referrerPolicy&&(o.referrerPolicy=d.referrerPolicy),d.crossOrigin==="use-credentials"?o.credentials="include":d.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(d){if(d.ep)return;d.ep=!0;const o=n(d);fetch(d.href,o)}})();var ye={},qe;function gs(){if(qe)return ye;qe=1;var s=ps();return ye.createRoot=s.createRoot,ye.hydrateRoot=s.hydrateRoot,ye}var bs=gs();/**
