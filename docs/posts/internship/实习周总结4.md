...
对于SSE的基本知识：[SSE简介 | xh's blog](https://ksladnasx.github.io/vuepress_blog/posts/sse/SSE简介.html)

对于源项目代码的解读：[SSE服务代码解读 | xh's blog](https://ksladnasx.github.io/vuepress_blog/posts/sse/sseService文件解析.html)

对于bug修复的思路：[最大连接次数突破 | xh's blog](https://ksladnasx.github.io/vuepress_blog/posts/sse/BroadcastChannel方式解决sse连接数限制.html)

最终完成的文件的解读：[sseService文件解读(BroadcastChannel版) | xh's blog](https://ksladnasx.github.io/vuepress_blog/posts/sse/BroadcastChannel版本sse解读.html)
...
![image-20251124111838525](..\img\工作流程.png)
