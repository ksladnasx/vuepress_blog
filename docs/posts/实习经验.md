...
Post http://localhost:3333/api/traffic/v1/1/target-group?tag=yx
...
请求体示例：{
    ...
    "azName": null,
    "name": "test",
    "vpcID": "vpc-np19r4c872",
    "healthCheckID": "hc-1002",
    "algorithm": "rr",
    "sessionSticky": {
        "sessionStickyMode": "CLOSE",
        "rewriteCookieName": ""
    },
    "status": "ACTIVE",
    "description": "tets",
    "createdTime": "2025-11-12T09:45:40.610Z",
    "updatedTime": "2025-11-12T09:45:40.610Z",
    "id": "tg-2025"
}

创建主机组接口post的数据中缺少能体现前端页面中用户选择的主机的变量
...
Get  http://localhost:3333/api/traffic/v1/1/target-group/list?tag=yx

返回的数据：{
    "clientToken": null,
    "targetGroupID": null,
    "projectID": "0",
    "regionID": "200000004033",
    "azName": null,
    "name": "scwtnew-8001",
    "vpcID": "vpc-np19r4c872",
    "healthCheckID": "hc-1rnov0rafo",
    "algorithm": "wrr",
    "sessionSticky": {
        "sessionStickyMode": "CLOSE",
        "cookieExpire": 0,
    ...
    "status": "ACTIVE",
    "description": "",
    "createdTime": "2025-07-02T02:17:38Z",
    "updatedTime": "2025-07-02T02:17:38Z",
    "id": "tg-vhtsss8pl3"
}

缺少主机组的主机数目的信息以及主机组名称



GET  http://localhost:3333/1/access-control?tag=yx

接口返回 304 Not Modified ，弹窗提示是非本系统接口（下面那行API什么的也试了）

那此处的白名单黑名单应该请求哪个接口呢![image-20251113110455944](C:\Users\wh826\AppData\Roaming\Typora\typora-user-images\image-20251113110455944.png)

![image-20251113110646587](C:\Users\wh826\AppData\Roaming\Typora\typora-user-images\image-20251113110646587.png)
