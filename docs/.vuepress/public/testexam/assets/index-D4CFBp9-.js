import{j as e,M as ls,r as ms,a as us}from"./vendor-markdown-DurMAUoW.js";import{a as ps,b as p,R as pe,u as Ge,N as ke,O as ys,c as oe,L as E,d as Qe,e as fs,f as Q,H as hs}from"./vendor-react-BBDYwFnM.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const d of document.querySelectorAll('link[rel="modulepreload"]'))r(d);new MutationObserver(d=>{for(const o of d)if(o.type==="childList")for(const h of o.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&r(h)}).observe(document,{childList:!0,subtree:!0});function n(d){const o={};return d.integrity&&(o.integrity=d.integrity),d.referrerPolicy&&(o.referrerPolicy=d.referrerPolicy),d.crossOrigin==="use-credentials"?o.credentials="include":d.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(d){if(d.ep)return;d.ep=!0;const o=n(d);fetch(d.href,o)}})();var ye={},qe;function gs(){if(qe)return ye;qe=1;var s=ps();return ye.createRoot=s.createRoot,ye.hydrateRoot=s.hydrateRoot,ye}var bs=gs();/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ts=[["circle",{cx:"12",cy:"12",r:"1",key:"41hilf"}],["path",{d:"M20.2 20.2c2.04-2.03.02-7.36-4.5-11.9-4.54-4.52-9.87-6.54-11.9-4.5-2.04 2.03-.02 7.36 4.5 11.9 4.54 4.52 9.87 6.54 11.9 4.5Z",key:"1l2ple"}],["path",{d:"M15.7 15.7c4.52-4.54 6.54-9.87 4.5-11.9-2.03-2.04-7.36-.02-11.9 4.5-4.52 4.54-6.54 9.87-4.5 11.9 2.03 2.04 7.36.02 11.9-4.5Z",key:"1wam0m"}]],Ps=g("atom",Ts);/**
 * @license lucide-react v1.41.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Js=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3",key:"1u773s"}],["path",{d:"M12 17h.01",key:"p32p05"}]],Pe=g("circle-question-mark",Js);/**
 * @license lucide-react v1.41.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Nt=[["path",{d:"M14.106 5.553a2 2 0 0 0 1.788 0l3.659-1.83A1 1 0 0 1 21 4.619v12.764a1 1 0 0 1-.553.894l-4.553 2.277a2 2 0 0 1-1.788 0l-4.212-2.106a2 2 0 0 0-1.788 0l-3.659 1.83A1 1 0 0 1 3 19.381V6.618a1 1 0 0 1 .553-.894l4.553-2.277a2 2 0 0 1 1.788 0z",key:"169xi5"}],["path",{d:"M15 5.764v15",key:"1pn4in"}],["path",{d:"M9 3.236v15",key:"1uimfh"}]],Tt=g("map",Nt);/**
 * @license lucide-react v1.41.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Pt=[["path",{d:"M12 19v3",key:"npa21l"}],["path",{d:"M19 10v2a7 7 0 0 1-14 0v-2",key:"1vc78b"}],["rect",{x:"9",y:"2",width:"6",height:"13",rx:"3",key:"s6n7sd"}]],es=g("mic",Pt);/**
 * @license lucide-react v1.41.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
**限制**：Proxy 无法代理基本类型，只能代理对象；对旧浏览器兼容性差，不能被完整 polyfill。`,ana:"回答要从“代理整个对象”解释 Vue3 的优势，而不是只说 Proxy 更强。",keys:["get/set 拦截","Reflect 默认行为","新增删除属性","Map/Set"],src:"ES6 高频题 / Vue 响应式原理"},{id:"js-042",type:"single",diff:"medium",sub:"异步编程",q:`下面代码的输出顺序是什么？
...
**使用场景**：自定义集合遍历、惰性序列、异步流程控制。async/await 的早期实现思路就可以看成 Generator + Promise 自动执行器。`,ana:"三者关系：Iterator 是协议，for...of 是消费协议的语法，Generator 是创建迭代器的语法糖。",keys:["Symbol.iterator","next()","yield","for...of"],src:"ES6 高频题"}],xa=[{id:"br-001",type:"essay",diff:"easy",sub:"进程与线程",q:"进程和线程的概念与区别是什么？浏览器渲染进程有哪些线程？",ans:`**面试回答：**
...
**选择**：当前页关键资源用 preload；未来页资源用 prefetch；第三方域名访问前可用 dns-prefetch/preconnect。preconnect 成本更高，域名不多且确定会访问时再用。`,ana:"preload 当前页高优先级，prefetch 未来页低优先级；preconnect 比 dns-prefetch 做得更多也更贵。",keys:["preload 当前页","prefetch 未来页","dns-prefetch","preconnect"],src:"浏览器资源加载高频题"},{id:"br-020",type:"single",diff:"medium",sub:"浏览器安全",q:"Cookie 的 SameSite=Lax 主要能降低哪类攻击风险？",opts:["XSS 脚本注入","CSRF 跨站请求伪造","SQL 注入","DNS 污染"],ans:"B",ana:"SameSite 用于限制第三方站点发起请求时是否携带 Cookie。Lax 在大多数跨站子请求中不携带 Cookie，可以降低 CSRF 风险；Strict 更严格；None 表示允许跨站携带，但必须同时设置 Secure。XSS 的核心防护是输出转义、CSP、HttpOnly 等。",keys:["SameSite","CSRF","Lax","Secure"],src:"浏览器安全高频题"},{id:"br-021",type:"essay",diff:"medium",sub:"渲染原理",q:"DOMContentLoaded 和 load 事件有什么区别？它们分别在什么时候触发？",ans:`**面试回答：**
...
**补充**：defer 脚本会在 DOM 解析完成后、DOMContentLoaded 之前按顺序执行；async 脚本下载完立即执行，执行时机不确定。`,ana:"DOMContentLoaded 关注 DOM 就绪，load 关注所有资源就绪。defer 与 DOMContentLoaded 的关系是常见追问。",keys:["DOM 解析完成","所有资源加载完成","defer 脚本","async 时机"],src:"浏览器渲染高频题"}],ka=[{id:"net-001",type:"essay",diff:"easy",sub:"HTTP 协议",q:"GET 和 POST 请求有哪些区别？",ans:`**面试回答：**
...
**项目策略**：index.html 通常 no-cache 或短缓存，保证能及时拿到最新资源入口；带内容 hash 的 JS/CSS/图片设置较长 max-age + immutable。`,ana:"no-cache 和 no-store 是高频混淆点：前者要协商，后者完全不存。",keys:["max-age","no-cache 协商","no-store 不存储","immutable"],src:"HTTP 缓存高频题"},{id:"net-023",type:"single",diff:"medium",sub:"HTTPS",q:"HTTPS 中数字证书最核心的作用是什么？",opts:["让 HTTP 请求体自动变小","证明服务器身份，并防止中间人替换服务器公钥","替代 TCP 三次握手","让浏览器不再需要 DNS 解析"],ans:"B",ana:"HTTPS 握手中服务端会返回证书，证书由受信任 CA 签发，包含域名、服务器公钥、有效期等信息。浏览器验证证书链、域名、有效期和吊销状态，确认公钥确实属于目标服务器，防止中间人把自己的公钥冒充成服务器公钥。",keys:["CA","证书链","服务器身份","防中间人"],src:"HTTPS 高频题"},{id:"net-024",type:"essay",diff:"medium",sub:"WebSocket",q:"WebSocket 为什么需要心跳机制？断线重连一般怎么设计？",ans:`**面试回答：**WebSocket 是长连接，但网络切换、代理超时、服务端重启、移动端后台等都可能导致连接半开：表面上连接还在，实际已经无法收发消息。所以需要心跳检测连接是否可用。
...
5. 页面卸载时清理定时器和连接。`,ana:"心跳解决半开连接检测，重连要处理退避、主动关闭、消息补偿和幂等。",keys:["心跳 ping/pong","半开连接","指数退避","消息补偿"],src:"WebSocket 稳定性高频题"}],Sa=[{id:"vue-001",type:"essay",diff:"medium",sub:"响应式原理",q:"说一下 Vue 的基本原理和双向数据绑定的实现。",ans:`**面试回答：**
...
**补充**：两者都可以返回清理函数或使用 onCleanup，处理请求取消、定时器清理等副作用。需要 DOM 更新后再执行时可配置 flush: 'post'。`,ana:"watch 显式依赖、watchEffect 自动依赖；是否需要 oldValue 是选择 watch 的重要依据。",keys:["显式依赖","自动收集依赖","oldValue","flush: post"],src:"Vue 组合式 API 高频题"},{id:"vue-029",type:"single",diff:"medium",sub:"组件基础",q:"Vue3 中自定义组件使用 v-model 时，默认对应的 prop 和事件分别是什么？",opts:["value 和 input","modelValue 和 update:modelValue","checked 和 change","value 和 update:value"],ans:"B",ana:'Vue3 自定义组件的 v-model 默认展开为 `:modelValue="xxx"` 和 `@update:modelValue="xxx = $event"`。Vue2 默认是 value + input。Vue3 还支持多个 v-model，如 `v-model:title` 对应 title + update:title。',keys:["modelValue","update:modelValue","多个 v-model"],src:"Vue 组件通信高频题"},{id:"vue-030",type:"essay",diff:"medium",sub:"状态管理",q:"Pinia 相比 Vuex 有哪些优势？在项目中如何划分 store？",ans:`**面试回答：**Pinia 是 Vue3 官方推荐的状态管理方案，相比 Vuex 更轻量：
...
**不建议无脑使用**：useMemo/useCallback 本身也有依赖比较和缓存维护成本，代码还会更复杂。普通轻量计算、没有传给 memo 子组件的函数，直接写通常更清晰。`,ana:"关键是说明“配合 memo 或昂贵计算才有意义”，不是看到函数就包 useCallback。",keys:["缓存计算结果","缓存函数引用","React.memo","依赖比较成本"],src:"React Hooks 高频题"},{id:"ra-029",type:"single",diff:"medium",sub:"Hooks",q:"useRef 修改 ref.current 后，React 默认会发生什么？",opts:["立即触发组件重新渲染","不会触发重新渲染，但当前值会在多次渲染之间保持","会清空组件 state","只能在 class 组件中使用"],ans:"B",ana:"useRef 返回稳定对象 `{ current }`，修改 current 不会触发渲染，但这个对象会在组件生命周期内保持同一引用。它适合保存 DOM 引用、定时器 ID、WebSocket/SSE 实例、最新回调等不直接参与 UI 展示的数据。参与视图展示的数据应使用 state。",keys:["不触发渲染","稳定引用","保存实例"],src:"React Hooks 高频题"},{id:"ra-030",type:"essay",diff:"medium",sub:"组件基础",q:"React Error Boundary 能捕获哪些错误？有哪些捕获不到？",ans:`**面试回答：**Error Boundary 是 React 的错误边界组件，用 class 组件实现，核心生命周期是 "getDerivedStateFromError" 和 "componentDidCatch"。
...
**实践建议**：一般在路由级或关键业务模块外层包裹 Error Boundary，做到局部模块异常不拖垮整个应用。`,ana:"Error Boundary 只兜 React 渲染链路，不是所有 JS 异常的万能捕获器。",keys:["getDerivedStateFromError","componentDidCatch","渲染错误","异步错误捕获不到"],src:"React 稳定性高频题"}],ja=[{id:"pf-001",type:"essay",diff:"medium",sub:"性能指标",q:"前端性能指标有哪些？FCP、LCP、INP、CLS 分别衡量什么？",ans:`**面试回答：**核心指标（Core Web Vitals）：
...
如果是后台系统，优先使用系统字体栈，通常比引入大体积自定义字体更稳。`,ana:"字体优化要同时考虑加载速度、可见性和 CLS，不能只说 preload。",keys:["font-display","preload font","字体子集化","CLS"],src:"前端性能优化.md"}],Ca=[{id:"en-001",type:"essay",diff:"easy",sub:"Git",q:"Git 和 SVN 的区别是什么？git pull 和 git fetch 的区别？",ans:`**面试回答：**
...
一句话：前端环境变量用于控制构建和运行入口，不是秘密存储。`,ana:"安全边界是本题关键：凡是打进前端包里的内容，都可以被用户看到。",keys:[".env","VITE_ 前缀","DefinePlugin","不能存密钥"],src:"前端工程化面试题.md"}],Ma=[{id:"al-001",type:"essay",diff:"medium",sub:"基础概念",q:"动态规划的核心特征有哪些？什么样的题目适合用动态规划？",ans:`**面试回答：**动态规划适合的问题有三个核心特征：
...
**复杂度**：每个字符最多进出窗口一次，时间 O(n)，空间 O(k)。`,ana:"关键是 `map.get(ch) >= left`，避免被窗口左侧已经失效的旧重复字符误伤。",keys:["滑动窗口","Map 记录下标","left 跳跃","O(n)"],src:"基础算法高频题"},{id:"al-023",type:"single",diff:"medium",sub:"动态规划",q:"爬楼梯问题：每次可以爬 1 或 2 阶，爬到第 n 阶的状态转移方程是什么？",opts:["dp[n] = dp[n - 1] + dp[n - 2]","dp[n] = dp[n - 1] * 2","dp[n] = n * n","dp[n] = max(dp[n - 1], dp[n - 2])"],ans:"A",ana:"到第 n 阶只有两种来源：从 n-1 阶再爬 1 阶，或从 n-2 阶再爬 2 阶，所以 dp[n] = dp[n-1] + dp[n-2]。初始化一般是 dp[1] = 1，dp[2] = 2。它本质是斐波那契模型，可用两个变量滚动优化到 O(1) 空间。",keys:["斐波那契模型","状态转移","滚动变量"],src:"动态规划入门题"},{id:"al-024",type:"essay",diff:"medium",sub:"树与图",q:"BFS 和 DFS 有什么区别？分别适合解决什么问题？",ans:`**面试回答：**
...
**选择**：要求“最少几步、最短距离、按层遍历”优先 BFS；要求“枚举所有可能、判断是否存在路径、递归结构明显”优先 DFS。`,ana:"一句话：DFS 适合深挖与回溯，BFS 适合层序和无权最短路。",keys:["递归/栈","队列","层序遍历","无权最短路"],src:"基础算法高频题"}],Na=[{id:"sc-001",type:"essay",diff:"medium",sub:"大文件上传",q:"大文件上传怎么做？分片、断点续传、并发控制的完整方案是什么？",ans:`**面试回答：**按“背景 → 方案 → 难点 → 结果”组织：
...
**项目表达**：在复杂筛选列表中，分页、关键词、筛选条件变化都可能触发请求，最稳的是把查询参数收敛成一个稳定 queryKey，用它管理请求、缓存和响应落地。`,ana:"请求竞态的核心是“只让最后一次有效请求落地”，AbortController 和 requestId 是常用组合。",keys:["请求竞态","防抖","AbortController","requestId","queryKey"],src:"问答类型面试题.md"},{id:"sc-021",type:"single",diff:"medium",sub:"表单体验",q:"复杂表单需要支持草稿自动保存时，下面哪个做法更合理？",opts:["每次输入都立即同步提交正式数据，并跳过校验","对表单变化做防抖保存草稿，区分草稿接口和正式提交接口","只把草稿存在内存中，刷新页面直接丢失","把所有用户草稿都写到同一个 localStorage key"],ans:"B",ana:"草稿自动保存应降低打扰且避免污染正式数据。常见做法是变化后防抖保存，草稿和正式提交分开；key 或接口参数包含用户、业务 ID、版本等信息；恢复时提示用户是否继续编辑旧草稿。",keys:["草稿保存","防抖","正式提交分离","恢复提示"],src:"业务场景题"},{id:"sc-022",type:"essay",diff:"medium",sub:"弱网与离线",q:"移动端或后台系统在弱网、断网场景下如何做体验兜底？",ans:`**面试回答：**弱网兜底要先区分核心链路和非核心链路：核心操作要明确成功、失败或可重试，非核心内容可以降级展示缓存或占位。
...
重点是让用户知道当前状态，并尽量保住已经输入或已经完成的进度。`,ana:"弱网题的评价点是状态清晰、可重试、保留用户成果，而不是简单弹一个网络错误。",keys:["弱网","退避重试","缓存兜底","表单保留","续传"],src:"问答类型面试题.md / 业务场景题"}],Ta=[{id:"pj-001",type:"essay",diff:"easy",sub:"自我介绍",q:"请做一个 30 秒的自我介绍（前端方向）。",ans:`**面试回答模板**（docs 知识点快速复习指南版）：
...
这样后端字段变化时，优先改接口封装和类型定义，页面组件只感知稳定的业务模型。`,ana:"这道题和 Mock 清理、Axios 封装一脉相承：差异收敛在接口层。",keys:["接口适配层","TypeScript 类型","Swagger","空态兜底"],src:"项目逻辑.md / 农担项目所遇问题及总结.md"}],Pa=[{id:"db-001",type:"essay",diff:"easy",sub:"SQL 基础",q:"SQL 数据库和 NoSQL 数据库有什么区别？",ans:`**面试回答：**
